...
import com.licon.syncadaptertest.authentication.ParseComServer;
...
import static com.licon.syncadaptertest.authentication.ParseComServer.getAppParseComHeaders;

public class ParseComServerAccessor {
    public List<TvShow> getShows(String auth) throws Exception {

        Log.d("licon-sync", "getShows auth[" + auth + "]");
        ...
        // taken from https://parse.com/questions/how-long-before-the-sessiontoken-expires

        try {
            HttpResponse response = httpClient.execute(httpGet);

            String responseString = EntityUtils.toString(response.getEntity());
            Log.d("licon-sync", "getShows> Response= " + responseString);
    ...
    public void putShow(String authtoken, String userId, TvShow showToAdd) throws Exception {
        ...
        Log.d("licon-sync", "putShow [" + showToAdd.name + "]");
        ...
        httpPost.addHeader("X-Parse-Session-Token", authtoken);
        // taken from https://parse.com/questions/how-long-before-the-sessiontoken-expires
        ...
        Log.d("licon-sync", "Request = " + request);
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() != 201) {
                ...
                //  Log.d("licon-sync", "Response string = " + responseString);
            }
